...
public class ParseFileTest {
    ...
    private static int numTest = 2540; //number of training examples
    private File theFile;

    public ParseFileTest() {
        input = new double[numTest][numInp];
        fileSolutions = new double[numTest];
        parseFile();
    }
    ...
    public void parseFile() {
        ...
        URL url = getClass().getResource("TestingData.txt");
        try {
